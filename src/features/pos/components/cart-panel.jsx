...
export function CartPanel({
    ...
    return (
        <div className={`
            ...
            {/* 2. SCROLLABLE CONTENT (Items + Order Options) */}
                ...
                <div className="p-4 space-y-6">
                    ...
                    {cart.length > 0 && (
                        <div className="space-y-4 pt-2">
                            ...
                            {/* Cash Inputs (Inside scroll area to avoid pushing footer, but near bottom) */}
                            {paymentMethod === 'cash' && (
                                    ...
                                    <div className="space-y-1.5">
                                        ...
                                        <div className="relative">
                                            ...
                                            <Input
                                                ...
                                                placeholder="0.00"
                                                className="pl-7 font-bold text-lg h-11 bg-card"
                                            />
                                        </div>
                                    </div>
                                    <div className="space-y-1.5">
                                        <Label className="text-xs font-medium text-muted-foreground">Cambio</Label>
                                        <div className="flex items-center px-4 h-11 rounded-md bg-muted/50 border border-transparent text-lg font-black text-muted-foreground tabular-nums">
                    ...
                    {/* Spacing for nice scrolling */}
                    <div className="h-4" />
                </div>
            </div>

            {/* 3. FIXED FOOTER (Totals & Action) */}
