    ...
    return (
        <div className="flex min-h-screen w-full">
            ...
            <div className="hidden lg:flex w-1/2 bg-zinc-900 relative items-center justify-center p-12 overflow-hidden">
                <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1514362545857-3bc16c4c7d1b?q=80&w=2070&auto=format&fit=crop')] bg-cover bg-center opacity-20 mix-blend-overlay"></div>
                ...
                <div className="relative z-10 text-center space-y-6 max-w-lg">
                    ...
                    <div className="space-y-4">
                        <h1 className="text-5xl font-black text-white tracking-tight">Gourmet <span className="text-[#d4af37]">Click</span></h1>
                        <p className="text-zinc-400 text-lg leading-relaxed">
                            Gestiona tu restaurante con elegancia y eficiencia. Control total desde la cocina hasta la mesa.
                        </p>
                    </div>
                </div>
